...
class FileIO:
    def __init__(
        ...
        if not base_path:
            env_abs_path = os.environ.get("EMAILS_DIR")
            if env_abs_path:
        ...
        self.filepath_raw = os.path.join(self.base_path, os.environ.get("RAW_EMAILS_DIR"))
        self.filepath_clean = os.path.join(self.base_path, os.environ.get("CLEAN_EMAILS_DIR"))
